defmodule Nektar.PolarCoordinateTest do
    ...
    test "relative polar coordinates test and postion update" do
        cog1 = %Cog{id: 1, x: 0, y: 0, theta: 0, state: [], pid: 0}
        cog2 = %Cog{id: 2, x: 0, y: 11, theta: 0, state: [], pid: 0}
        list = %{1 => cog1, 2 => cog2}
        ...
        assert new_cog1 == %Cog{id: 1, x: 0, y: 1, theta: 0, state: [], pid: 0}
        ...
        assert new_cog2 == %Cog{id: 2, x: 0, y: 10, theta: 180.0, state: [], pid: 0}
    end
